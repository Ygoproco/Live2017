...
function c101001005.initial_effect(c)
	...
	e1:SetCondition(c101001005.spcon)
	e1:SetTarget(c101001005.sptg)
	e1:SetOperation(c101001005.spop)
	c:RegisterEffect(e1)
	--special summon
	local e2=Effect.CreateEffect(c)
	e2:SetDescription(aux.Stringid(101001005,0))
	e2:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e2:SetType(EFFECT_TYPE_IGNITION)
	e2:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e2:SetRange(LOCATION_MZONE)
	e2:SetCountLimit(1,101001905)
	e2:SetCost(c101001005.spcost)
...
function c101001005.spcon(e,tp,eg,ep,ev,re,r,rp)
	return rp==1-tp and eg:IsExists(c101001005.cfilter,1,e:GetHandler(),tp)
end
function c101001005.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and e:GetHandler():IsCanBeSpecialSummoned(e,0,tp,false,false) end
	Duel.SetOperationInfo(0,CATEGORY_SPECIAL_SUMMON,e:GetHandler(),1,0,0)
end
function c101001005.spop(e,tp,eg,ep,ev,re,r,rp)
...
function c101001005.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c101001005.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c101001005.spop(e,tp,eg,ep,ev,re,r,rp,chk)
