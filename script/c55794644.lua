...
function c55794644.condition(e,tp,eg,ep,ev,re,r,rp)
	if Duel.IsExistingMatchingCard(c55794644.sanctfilter,0,LOCATION_ONFIELD,LOCATION_ONFIELD,1,nil) or (Duel.IsEnvironment(56433456))
	then return e:GetHandler():GetFlagEffect(55794644)<2
...
function c55794644.sanctfilter(c)
