...
function c101003021.indfilter(c,tp,seq)
	return c:IsFaceup() and c:IsSetCard(0xfe) and c:IsControler(tp) and c:GetSequence()==seq
end
function c101003021.indcon(e)
	local tp=e:GetHandlerPlayer()
	return Duel.IsExistingMatchingCard(c101003021.indfilter,tp,LOCATION_ONFIELD,0,1,e:GetHandler(),tp,e:GetHandler():GetSequence())
end
