...
function c44686185.filter4(c,e,tp,rc)
	...
	return c44686185.filter1(c) and ft+ct>0
		and Duel.IsExistingTarget(c44686185.filter2,tp,LOCATION_GRAVE,0,1,nil,e,tp,g)
end
...
function c44686185.filter2(c,e,tp,g)
	return c:IsSetCard(0x3d) and not c:IsCode(44686185) and (not g or not g:IsContains(c))
...
function c44686185.reptg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	return Duel.SelectYesNo(tp,aux.Stringid(44686185,1))
end
