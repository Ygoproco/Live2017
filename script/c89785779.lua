...
function c89785779.eqfilter(c)
	...
	return c:IsFaceup() and ((c:IsSetCard(0x110) and c:IsType(TYPE_FUSION)) or c:IsCode(64631466,63519819)) and m and m.CanEquipMonster(c)
end
...
function c89785779.thfilter(c,e)
	return (c:IsSetCard(0x110) and c:IsType(TYPE_FUSION)) or c:IsCode(64631466,63519819)
end
