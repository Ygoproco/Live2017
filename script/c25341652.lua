...
function c25341652.repfilter(c,tp)
	return c:IsFaceup() and c:IsControler(tp) and not c:IsReason(REASON_REPLACE) and c:IsLocation(LOCATION_MZONE) and c:IsSetCard(0x6d) and c:CheckRemoveOverlayCard(tp,1,REASON_EFFECT)
end
