...
c80959027.spell_counter_permit=99
...
function c80959027.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c80959027.thfilter,tp,LOCATION_SZONE+LOCATION_EXTRA,0,1,nil) end
...
function c80959027.thop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,c80959027.thfilter,tp,LOCATION_SZONE+LOCATION_EXTRA,0,1,1,nil)
