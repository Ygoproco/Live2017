...
function c52714670.spfilter(c,e,tp)
	return c:IsFaceup() and (c:IsCode(89189982,36898537) or c:IsSetCard(0x105))
...
function c52714670.rmcfilter(c,tp)
	return c:IsControler(tp) and c:IsFaceup() and (c:IsCode(89189982,36898537) or c:IsSetCard(0x105))
end
