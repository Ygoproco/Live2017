...
function c41209827.initial_effect(c)
	...
	e4:SetCountLimit(1)
	e4:SetOperation(c41209827.reset)
...
function c41209827.copytg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.IsExistingTarget(c41209827.copyfilter,tp,0,LOCATION_MZONE,1,nil) and e:GetLabel()==0 end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_FACEUP)
