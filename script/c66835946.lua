...
function c66835946.destg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		...
		return eg:GetCount()==1 and tc:IsLocation(LOCATION_MZONE) and tc:IsControler(tp) and not tc:IsReason(REASON_REPLACE) and tc:IsFaceup() and tc:IsRace(RACE_ZOMBIE)
	end
