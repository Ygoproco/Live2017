...
function c54366836.damop2(e,tp,eg,ep,ev,re,r,rp)
    ...
    e1:SetCondition(c54366836.refcon)
    e1:SetOperation(c54366836.refop)
    e1:SetReset(RESET_PHASE+PHASE_DAMAGE_CAL)
    Duel.RegisterEffect(e1,tp)
end
function c54366836.refcon(e,tp,eg,ep,ev,re,r,rp)
    return ep==tp
end
function c54366836.refop(e,tp,eg,ep,ev,re,r,rp)
