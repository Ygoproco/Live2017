...
function c55787576.initial_effect(c)
	...
	e2:SetCondition(c55787576.indcon)
	...
	e3:SetCondition(c55787576.indcon)
...
function c55787576.aclimit(e,re,tp)
...
function c55787576.indfilter(c,tp,seq)
	return c:IsFaceup() and c:IsSetCard(0xfe) and c:IsControler(tp) and c:GetSequence()==seq
end
function c55787576.indcon(e)
	local tp=e:GetHandlerPlayer()
	return Duel.IsExistingMatchingCard(c55787576.indfilter,tp,LOCATION_ONFIELD,0,1,e:GetHandler(),tp,e:GetHandler():GetSequence())
end
function c55787576.indval(e,re,tp)
