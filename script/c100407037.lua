...
function c100407037.hspfilter(c,tp,sc)
	return c:IsSetCard(0x2034) and c:GetLevel()==10 and c:IsControler(tp)
end
function c100407037.hspcon(e,c)
	if c==nil then return true end
	return Duel.GetLocationCount(c:GetControler(),LOCATION_MZONE)>-1 and Duel.CheckReleaseGroup(c:GetControler(),c100407037.hspfilter,1,nil,c:GetControler(),c)
end
