...
function c1855932.repfilter(c,tp)
	return c:IsFaceup() and c:IsControler(tp) and not c:IsReason(REASON_REPLACE) and c:IsLocation(LOCATION_MZONE) and c:IsSetCard(0x88) and c:IsRace(RACE_BEASTWARRIOR)
end
