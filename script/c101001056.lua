...
function c101001056.initial_effect(c)
	--Activate
	local e1=Effect.CreateEffect(c)
	e1:SetCategory(CATEGORY_SPECIAL_SUMMON+CATEGORY_RECOVER)
	e1:SetType(EFFECT_TYPE_ACTIVATE)
	e1:SetCode(EVENT_FREE_CHAIN)
	e1:SetCost(c101001056.cost)
	e1:SetTarget(c101001056.target)
	e1:SetOperation(c101001056.activate)
	c:RegisterEffect(e1)
end
function c101001056.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	e2:SetTarget(c101001056.sumlimit)
...
function c101001056.sumlimit(e,c,sump,sumtype,sumpos,targetp,se)
	return e:GetLabelObject()~=se
end
function c101001056.filter(c,e,tp)
