...
function c100418023.initial_effect(c)
	...
	e1:SetCondition(c100418023.con)
	e1:SetTarget(c100418023.tg)
	e1:SetOperation(c100418023.op)
	c:RegisterEffect(e1)
	--search S/T
	...
	e2:SetCountLimit(1,100418023)
	e2:SetCost(c100418023.cost)
	e2:SetTarget(c100418023.target)
	e2:SetOperation(c100418023.operation)
	c:RegisterEffect(e2)
	--send to grave
	local e3=Effect.CreateEffect(c)
	e3:SetDescription(aux.Stringid(100418023,2))
	e3:SetCategory(CATEGORY_TOGRAVE)
	e3:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_TRIGGER_O)
	e3:SetCode(EVENT_PRE_DAMAGE_CALCULATE)
	e3:SetRange(LOCATION_SZONE)
	e3:SetCountLimit(1,100418023+100)
	e3:SetCondition(c100418023.gycon)
	e3:SetTarget(c100418023.gytg)
	e3:SetOperation(c100418023.gyop)
	c:RegisterEffect(e3)
end
