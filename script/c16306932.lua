...
function c16306932.hspfilter1(c,g,ft)
	...
	return c:IsType(TYPE_FUSION) and g:IsExists(c16306932.hspfilter2,1,nil,g,rg,ft)
end
function c16306932.hspfilter2(c,g,rg,ft)
	...
	local ct=ft
	if c:IsLocation(LOCATION_MZONE) and c:GetSequence()<5 then ct=ct+1 end
	return c:IsType(TYPE_SYNCHRO) and g:IsExists(c16306932.hspfilter3,1,nil,rg2,ft)
end
function c16306932.hspfilter3(c,g,ft)
...
function c16306932.hspop(e,tp,eg,ep,ev,re,r,rp,c)
	...
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_RELEASE)
	local g2=g:FilterSelect(tp,c16306932.hspfilter2,1,1,nil,g,g1,ft)
	g1:Merge(g2)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_RELEASE)
	local g3=g:FilterSelect(tp,c16306932.hspfilter3,1,1,nil,g1,ft)
	g1:Merge(g3)
