...
function c84177693.reccon(e,tp,eg,ep,ev,re,r,rp)
	return not e:GetHandler():IsReason(REASON_BATTLE) and Duel.IsExistingMatchingCard(c84177693.sanctfilter,0,LOCATION_ONFIELD,LOCATION_ONFIELD,1,nil)
		or (Duel.IsEnvironment(56433456))
end
...
function c84177693.sanctfilter(c)
