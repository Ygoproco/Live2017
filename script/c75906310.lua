...
function c75906310.spfilter(c,code)
...
function c75906310.spcon(e,c)
	...
	return Duel.GetLocationCount(tp,LOCATION_MZONE)>-3
		and Duel.IsExistingMatchingCard(c75906310.spfilter,tp,LOCATION_ONFIELD+LOCATION_GRAVE,0,1,nil,84243274)
		and Duel.IsExistingMatchingCard(c75906310.spfilter,tp,LOCATION_ONFIELD+LOCATION_GRAVE,0,1,nil,73879377)
		and Duel.GetFlagEffect(tp,75906310)~=0 and Duel.GetFlagEffect(tp,75906311)~=0
end
function c75906310.spop(e,tp,eg,ep,ev,re,r,rp,c)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_REMOVE)
	local g1=Duel.SelectMatchingCard(tp,c75906310.spfilter,tp,LOCATION_ONFIELD+LOCATION_GRAVE,0,1,1,nil,84243274)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_REMOVE)
	local g2=Duel.SelectMatchingCard(tp,c75906310.spfilter,tp,LOCATION_ONFIELD+LOCATION_GRAVE,0,1,1,nil,73879377)
	g1:Merge(g2)
