...
function c56673480.drop(e,tp,eg,ep,ev,re,r,rp)
	...
	while tc do
		pg:AddCard(tc)
		tc:RegisterFlagEffect(100213158,RESET_EVENT+0x1fe0000,0,1)
		tc=eg:GetNext()
	end
end
...
function c56673480.pubtg(e,c)
	return e:GetLabelObject():IsContains(c) and c:GetFlagEffect(100213158)~=0
end
function c56673480.sfilter(c,pg)
	return c:IsPublic() and pg:IsContains(c) and c:GetFlagEffect(100213158)>0 and c:IsType(TYPE_SPELL)
end
