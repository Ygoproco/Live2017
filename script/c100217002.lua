...
function c100217002.initial_effect(c)
	...
	e2:SetCondition(c100217002.atkcon)
	e2:SetOperation(c100217002.atkop)
	c:RegisterEffect(e2)
end
...
function c100217002.atkcon(e,tp,eg,ep,ev,re,r,rp)
