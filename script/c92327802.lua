...
function c92327802.initial_effect(c)
	...
	e2:SetDescription(aux.Stringid(92327802,0))
...
function c92327802.tg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsLocation(LOCATION_MZONE) and c92327802.filter(chkc) end
	if chk==0 then return Duel.IsExistingTarget(c92327802.filter,tp,LOCATION_MZONE,LOCATION_MZONE,1,nil) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_FACEUP)
	local g=Duel.SelectTarget(tp,c92327802.filter,tp,LOCATION_MZONE,LOCATION_MZONE,1,1,nil)
