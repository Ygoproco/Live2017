...
function c10928224.initial_effect(c)
	...
	e5:SetCondition(c10928224.sumcon)
	c:RegisterEffect(e5)
	local e6=e5:Clone()
...
function c10928224.sumfilter(c)
	return c:IsFaceup() and c:GetOriginalCode()==10979723
end
function c10928224.sumcon(e)
	local c=e:GetHandler()
	return Duel.IsExistingMatchingCard(c10928224.sumfilter,c:GetControler(),LOCATION_MZONE,0,1,c)
end
