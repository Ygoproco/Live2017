...
function c29432356.initial_effect(c)
	...
	e5:SetOperation(c29432356.sumop)
	c:RegisterEffect(e5)
end
...
function c29432356.sumop(e,tp,eg,ep,ev,re,r,rp)
	if Duel.GetFlagEffect(tp,29432356)~=0 then return end
	local e1=Effect.CreateEffect(e:GetHandler())
	e1:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_CONTINUOUS)
	e1:SetCode(EVENT_ADJUST)
	e1:SetReset(RESET_PHASE+PHASE_END)
	e1:SetOperation(c29432356.regop)
	Duel.RegisterEffect(e1,tp)
	Duel.RegisterFlagEffect(tp,29432356,RESET_PHASE+PHASE_END,0,1)
end
function c29432356.regop(e,tp,eg,ep,ev,re,r,rp)
