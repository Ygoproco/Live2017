...
function c78063197.filter2(c,e,tp,m,f,chkf)
	return c:IsType(TYPE_FUSION) and (not f or f(c)) and (c:IsSetCard(0x110) or c:IsCode(63519819))
...
function c78063197.eqfilter(c)
	...
	return c:IsFaceup() and (c:IsSetCard(0x110) or c:IsCode(64631466,63519819)) and m and m.CanEquipMonster(c)
end
