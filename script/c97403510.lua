...
function c97403510.initial_effect(c)
    ...
    e1:SetCondition(c97403510.refcon)
    e1:SetOperation(c97403510.refop)
    c:RegisterEffect(e1)
...
function c97403510.refcon(e,tp,eg,ep,ev,re,r,rp)
    local c=e:GetHandler()
    return ep==tp and c:IsRelateToBattle() and eg:GetFirst()==c:GetBattleTarget()
end
function c97403510.refop(e,tp,eg,ep,ev,re,r,rp)
