...
function c57135971.initial_effect(c)
	...
	e1:SetCondition(c57135971.condition)
...
function c57135971.condition(e,tp,eg,ep,ev,re,r,rp)
...
function c57135971.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	local g=Duel.SelectTarget(tp,c57135971.filter,tp,LOCATION_MZONE,0,1,1,nil)
