...
function c5817857.destg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		...
		return tc:IsFaceup() and tc:IsLocation(LOCATION_MZONE) and tc:IsSetCard(0x1d) and not tc:IsReason(REASON_REPLACE) and tc:IsReason(REASON_BATTLE+REASON_EFFECT)
